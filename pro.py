...
def bills():
   ...
   billing.geometry("1366x768+0+0")
   tf=Frame(billing,width=1200,height=60,relief="raise",bd=10)
   tf.pack(side=TOP)
   tf1=Frame(billing,width=1200,height=100,relief="raise",bd=10)
   tf1.pack(side=TOP)
   lf=Frame(billing,width=800,height=700,relief="raise",bd=10)
   lf.pack(side=LEFT)
   ...
   rf=Frame(billing,width=600,height=700,relief="raise",bd=10)
   rf.pack(side=RIGHT)
   rf1=Frame(rf,width=600,height=50,relief="raise",bd=6,bg='powder blue')
   rf1.pack(side=TOP)
   rf2=Frame(rf,width=600,height=450,relief="sunken",bd=6)
   rf2.pack(side=TOP)
   rf3=Frame(rf,width=600,height=150,relief="raise",bd=6)
   rf3.pack(side=TOP)
   title=Label(tf,font=("arial",40,"bold"),fg="blue",text="     A-Z ICE-CREAMS     ")
   title.pack(side=RIGHT)
   d=Label(tf1,font=("arial",40,"bold"),fg="blue",text=str(date))
   d.pack()
   #-====================Functions===================================
   def create_table():
   ...
   def reset():
       ...
       txt.configure(state='disabled')
   #===================Labels======================================
   typ1=Label(lf1a,text="Type",font=('arial',20,'bold'),fg='blue')
   typ1.grid(row=0,column=0,padx=10,pady=10,sticky=W)
   qty1=Label(lf1a,text="Qty",font=('arial',20,'bold'),fg='blue')
   qty1.grid(row=0,column=1,padx=10,pady=10,sticky=W)
   rate1=Label(lf1a,text="Rate",font=('arial',20,'bold'),fg='blue')
   ...
   typ2=Label(lf1b,text="Type",font=('arial',20,'bold'),fg='blue')
   typ2.grid(row=0,column=0,padx=10,pady=10,sticky=W)
   qty2=Label(lf1b,text="Qty",font=('arial',20,'bold'),fg='blue')
   qty2.grid(row=0,column=1,padx=10,pady=10,sticky=W)
   rate2=Label(lf1b,text="Rate",font=('arial',20,'bold'),fg='blue')
   ...
   l12=Label(lf2a,text="Service charge",font=('arial',20,'bold'),fg='blue4')
   l12.grid(row=1,column=0,padx=10,pady=10,sticky=W)
   l13=Label(lf2b,text="Tax",font=('arial',20,'bold'),fg='blue4')
   ...
   l19=Label(rf1,text="Receipt",font=('arial',15,'bold'),bg='powder blue',fg='black')
   ...
   #=================buttons====================
   b1=Button(rf3,image=timg,text="Total",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=total)
   b1.grid(row=0,column=1)
   b2=Button(rf3,image=reimg,text="Receipt",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=reciept)
   b2.grid(row=0,column=2)
   b3=Button(rf3,image=rimg,text="Reset",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=reset)
   b3.grid(row=0,column=3)
   b4=Button(rf3,image=qimg,text="Quit",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=quit)
   b4.grid(row=0,column=4)
   b5=Button(rf3,image=himg,font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=goback)
   b5.grid(row=0,column=0)
   b6=Button(rf3,image=simg,text="Quit",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=save)
...
def getinfo():
   ...
   info.geometry("1200x800+0+0")
   tf=Frame(info,width=1200,height=60,relief='raise',bd=10)
   tf.pack(side=TOP)
   title=Label(tf,font=("arial",40,"bold"),text="   ICE CREAM BILLING SYSTEM   ",fg="blue")
   title.pack()
   lf=Frame(info,width=500,height=740,relief='raise',bd=10)
   lf.pack(side=LEFT)
   rf=Frame(info,width=700,height=740,relief='raise',bd=10)
   rf.pack(side=RIGHT)
   def get():
       txt.configure(state='normal')
       txt.delete('1.0',END)
       ...
       for i in d:
           ...
           txt.configure(state='disabled')
   l1=Label(lf,text="Bill_no",font=('arial',20,'bold'),fg="blue")
   l1.pack(side=LEFT)
   var15=IntVar()
   e15=Entry(lf,font=('arial',20,'bold'),fg="blue",width=7,textvariable=var15)
   e15.pack(side=LEFT)
   b1=Button(lf,image=seimg,command=get)
   b1.pack(side=LEFT) 
   txt=Text(rf,width=50,height=50)
   txt.pack(side=LEFT)
   s=Scrollbar(rf)
   s.pack(side=LEFT)
   s.config(command=txt.yview)
   txt.configure(state='disabled',yscrollcommand=s.set)
   txt.pack(side=LEFT)
top=Frame(root,width=1200,height=60,relief='raise',bd=8)
top.pack(side=TOP)
title=Label(top,font=("arial",40),text="   ICE CREAM BILLING SYSTEM   ",fg="blue")
title.pack()
top1=Frame(root,width=1200,height=60,relief='raise',bd=8)
top1.pack(side=TOP)
t1=Label(top1,text="Which System you want to load ?",font=('arial',20,'italic'),fg='blue')
t1.pack()
billbtn=Button(root,text="Billing",command=bills)
billbtn.pack()
recbtn=Button(root,text="get_info",command=getinfo)
recbtn.pack()
root.mainloop()
