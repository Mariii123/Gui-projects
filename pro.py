...
def bills():
   ...
   def reset():
       ...
       txt.delete("1.0",END)
       txt.configure(state='disabled')
   title=Label(tf,font=("arial",30,"bold"),fg="blue",text="                    A-Z   ICE-CREAMS                           ")
   ...
   #=================buttons====================
   b1=Button(rf3,text="Total",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=total)
   b1.grid(row=0,column=1,padx=10,pady=10)
   b2=Button(rf3,text="Receipt",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=reciept)
   b2.grid(row=0,column=2,padx=10,pady=10)
   b3=Button(rf3,text="Reset",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=reset)
   b3.grid(row=0,column=3,padx=10,pady=10)
   b4=Button(rf3,text="Quit",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=quit)
   b4.grid(row=1,column=3,padx=10,pady=5)
   b5=Button(rf3,text="Home",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=goback)
   b5.grid(row=1,column=1,padx=10,pady=5)
   b6=Button(rf3,text="Save",font=("arial",15,'bold'),fg="black",bg='powder blue',relief='ridge',bd=8,command=save)
...
def getinfo():
   ...
   tf.pack(side=TOP)
   title=Label(tf,font=("arial",30,"bold"),text="A-Z Ice-Creams",fg="blue")
   title.pack()
   title1=Label(tf,font=("arial",15,"bold"),text="Retreiving System",fg="blue")
   title1.pack()
   ...
   e15.pack(side=LEFT)
   b1=Button(lf,text="search",command=get)
   b1.pack(side=LEFT) 
