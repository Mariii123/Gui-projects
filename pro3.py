...
def ug():
      ...
      dox.title('About ICBS')
      def close():
         root.deiconify()
         dox.withdraw()
      def license():
         lic=Toplevel()
         c=Canvas(lic,width=600,height=600,bd=5)
         c.create_rectangle(0,0,600,500,fill='white')
         def close():
            lic.withdraw()
         txt=Text(c,width=61,height=20,relief='ridge',bd=10)
         b1=Button(c,text="Close",command=close)
      ...
      c=Canvas(dox,width=280,height=440,bd=5)
      c.create_rectangle(5,5,420,372,fill='gray')
      c.create_image(75,60,image=img)
      c.create_text(165,65,font=('georgia',25),text="ICBS")
      c.create_text(150,140,font=('georgia',10),text="Marish's Ice Cream Billing System")
      c.create_text(120,200,font=('georgia',10),text="mail : marishwaran22@gmail.com")
      c.create_line(0,220,330,220)
      c.create_text(75,240,font=('georgia',10),text="ICBS version: 1.0")
      b1=Button(c,text='License',relief='flat',bd=5,command=license)
      b1.place(x=20,y=300)
      b2=Button(c,text='Copyright',relief='flat',bd=5,command=copyright)
      b2.place(x=110,y=300)
      b3=Button(c,text='Credits',relief='flat',bd=5,command=credits)
      b3.place(x=220,y=300)
      b4=Button(c,text="Close",relief='raise',bd=5,command=close)
      b4.place(x=120,y=400)
      c.pack()
      dox.mainloop()
